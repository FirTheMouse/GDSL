...
namespace Acorn {   
    ...
    struct ColCol : Col {
        ...
        // void pop(Col& out) {
        //     uint32_t last = size - element_size;
        //     memcpy(&out, &storage[last], element_size);
        //     Col* zombie = (Col*)&storage[last];
        //     zombie->storage = nullptr;
        //     zombie->label.storage = nullptr;
        //     zombie->cells.nullstorage();
        //     zombie->free.nullstorage();
        //     size -= element_size;
        // }
    };
    ...
    class Unit : public q_object {
        ...
        struct TCol : CCol {
            ...
            TCol() {}
            TCol(uint32_t _size) : CCol(_size) {}
            TCol(uint32_t _size, uint32_t _tag) : CCol(_size, _tag) {}
            TCol(const CCol& o) : CCol(o) {}
            TCol(const TCol& o) : CCol((const CCol&)o), specialization(o.specialization), form(o.form) {}
            TCol(TCol&& o) : CCol(std::move(o)), specialization(o.specialization), form(o.form) {}
